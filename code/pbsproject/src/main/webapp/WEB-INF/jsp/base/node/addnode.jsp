...
<form id="nodeform" action="${baseurl}node/addnodesubmit.action" method="post">
					...
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							...
							<TR>
								...
								<div>
								<input type="text" id="node_zh" name="pbsNodeInfoCustom.zh"  />
								</div>
								...
								<TD class=category width="35%">
								<div>
								<input type="text" id="node_zt" name="pbsNodeInfoCustom.zt"  />
								</div>
							...
							<TR>
								...
								<TD class=category width="35%">
								<div>
									<input type="text" id="node_bm" name="pbsNodeInfoCustom.bm" />
								</div>
								...
								<TD class=category width="35%">
								<div>
									<input type="text" id="node_zd" name="pbsNodeInfoCustom.zd" />
								</div>
